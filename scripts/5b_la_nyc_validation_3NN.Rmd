...
sbelfkLogistic= makePreds(testData = dplyr::select(sbelfk, -contains('pred')), modelsFrame = threeNNScaredParentLogisticModFrame, modelType = 'logistic')
```
...
rocPlot = ggroc(rocList) +
  ...
  labs(x = 'Sensitivity', y = 'Specificity', title = 'D', subtitle = 'ROC curves') +
